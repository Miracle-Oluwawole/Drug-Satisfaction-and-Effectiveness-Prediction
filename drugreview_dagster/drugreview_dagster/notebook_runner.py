...
@op(
    config_schema={
        "notebook_path": Field(StringSource, description="Path to the Jupyter notebook to execute"),
        "working_dir": Field(StringSource, default_value=str(Path.cwd()), description="Working directory used when executing the notebook"),
